...
const Navbar = () => {
    ...
    return ( <
        ...
        div > {
            ...
            className = "flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700" > < img className = "w-5"
            ...
            <
            div className = "absolute hidden group-hover:block top-0 right-9 z-10 text-black rounded pt-12" >
